...
<p class="large-p">Improve usability of an ecommerce website to drive conversion and revenue.</p>
...
<dl class="summary-list radius shadow">
    ...
    <div class="summary-list__row">
        ...
        <dd class="summary-list__value">
          Workshop facilitation, user research, UX design, wireframing, pattern design, front end development
        </dd>
    </div>
    <div class="summary-list__row">
        <dt class="summary-list__key">
...
<div class="x-img-container">
    <img src="../img/research-img/bench-4.png" class="x-img">
  </div>
  <div class="x-img-container">
    <img src="../img/research-img/bench-5.png" class="x-img">
  </div>
  <div class="x-img-container">
    <img src="../img/research-img/bench-8.png" class="x-img">
  </div>
  <div class="x-img-container">
    <img src="../img/research-img/bench-9.png" class="x-img">
  </div>
</div>
...
<p>Once these changes had been implemented, we did two more rounds of device testing to streamline the product. We logged issues as a team and I sketched improvements each time to pass back to the dev team for the next iteration.</p>
<p>Due to the fact that there was an existing product that had know issues, we iterated directly on the live product rather than spending extra time and resource on building a prototype.</p>
