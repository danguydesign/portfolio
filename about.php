      ...
      <div class="container padding-responsive">
        ...
        <div class="col-third padding">
          <div class="img-box radius">
            <img src="img/about/me-y.jpg" alt="Photo of Daniel Guy standing in a field" class="portrait-img">
          </div>
        </div>
          ...
          <div class="padding">
            ...
            <div class="light-black radius">
              <div class="text-box padding-1024 align-center">
                ...
                <p class="margin-bottom-6">I have experience: planning and running user research; running workshops with users and stakeholders; analysing findings; creating visuals and prototypes; iterating on design work in a testing cycle; handing over design work to developers; and delivering front end work in code.</p>
                ...
                <p class="margin-bottom-6">I also have experience with the GOV.UK prototyping kit, using html, css and javaScript. The GOV.UK prototyping kit can be used alongside their Design System, meaning that hi-fi journeys can be created rapidly by copying, pasting and amending snippets of code.</p>
                ...
                <p class="margin-bottom-6">I currently work with a researcher and a content designer on the UX side as well as a team of engineers. I like to work closely with product owners and am able to communicate effectively with developers due to my programming and front end skills.</p>
                ...
                <p class="margin-bottom-6">My personal preference when doing hi-fi work is to design in-browser, so my medium is flexible from the start, and micro-interactions and screen states are accounted for.</p>
